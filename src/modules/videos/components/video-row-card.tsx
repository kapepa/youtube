...
import { VideoGridCardSkeleton } from "./video-grid-card";
...
const VideoRowCardSkeleton: FC<VariantProps<typeof videoRowCardVariants>> = (props) => {
...
const VideoRowCard: FC<VideoRowCardProps> = (props) => {
  const { data, size = "default", onRemove } = props;
