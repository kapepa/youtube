...
const HomeVideosSection: FC<HomeVideosSectionProps> = (props) => {
  return (
    <Suspense
...
const HomeVideosSectionSkeleton: FC<HomeVideosSectionProps> = (props) => {
  return (
    <div>
      <div
...
const HomeVideosSectionSuspense: FC<HomeVideosSectionProps> = (props) => {
